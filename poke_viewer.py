...
frm_btm_left.grid(row=1, column=0, sticky=N) #needs padding

frm_btm_right = ttk.LabelFrame(root, text = 'Stats')
frm_btm_right.grid(row=1, column=1, sticky=N) #needs padding
...
prg_special_attack.grid(row=3, column =1)
...
prg_special_defence.grid(row=4, column =1)
